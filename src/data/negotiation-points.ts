...
export const NEGOTIATION_POINTS: NegotiationPoint[] = [
  ...
  },
  {
    ...
    title: '研磨材・砥石・処理費の上昇を示す',
    description: '研削・研磨に使う研磨材・砥石に加え、研磨粉・廃液の産業廃棄物処理費の上昇を説明します。',
    indicatorIds: ['cgpi-abrasive', 'cgpi-lubricant', 'sppi-industrial-waste-disposal'],
    suggestedOwnDocuments: ['砥石・研磨材の購入実績', '研削液の購入実績', '廃棄物処理費の実績'],
    howToExplain: '研磨材・産業廃棄物処理の公的指数で市場傾向を示し、自社の購入・処理費実績で補足します。',
  },
  ...
  },
  {
    ...
    fieldId: 'sheet-metal',
    category: 'consumables',
    title: 'ボルト・ナット等の購入部品の上昇を示す',
    description: '製缶・組立で使うボルト・ナット等の購入部品（副資材）の価格上昇を説明します。',
    indicatorIds: ['cgpi-bolts-nuts'],
    suggestedOwnDocuments: ['購入部品・副資材の改定通知', '直近の仕入明細'],
    howToExplain: 'ボルト・ナットの公的指数で市場傾向を示し、自社の購入明細で個別影響を補足します。',
  },
  ...
  // --- めっき・コーティング ---
  {
    ...
    fieldId: 'plating',
    category: 'material',
    title: '非鉄金属・塗料・処理費の上昇を示す',
    description: 'めっき・コーティングの非鉄金属・塗料に加え、排水・廃液の産業廃棄物処理費の上昇を説明します。',
    indicatorIds: ['cgpi-nonferrous', 'cgpi-paint', 'sppi-industrial-waste-disposal'],
    suggestedOwnDocuments: ['薬品・非鉄金属の改定通知', '塗料の購入実績', '排水・廃棄物処理費の実績'],
    howToExplain: '非鉄金属・塗料・産業廃棄物処理の公的指数で市場傾向を示し、自社の処理費実績で補足します。',
  },
  {
    id: 'plating-energy',
    fieldId: 'plating',
    category: 'energy',
    title: '電力・用水（水道）コストの上昇を示す',
    description: '整流器・加温・洗浄などの電力と、用水（水道）コストの上昇を説明します。',
    indicatorIds: ['cgpi-electricity', 'cgpi-water', 'minimum-wage-national-average'],
    suggestedOwnDocuments: ['電力・水道料金明細', '賃金改定資料'],
    howToExplain: '電力・水道の公的指数と最低賃金の上昇を示し、自社の料金・賃金資料で補足します。',
  },
  ...
  // --- 熱処理 ---
  {
    ...
    category: 'energy',
    title: '炉エネルギー（ガス・LPG・重油・電力）の上昇を示す',
    description: '加熱炉を連続運転する熱処理は、ガス・LPG・重油・電力など炉エネルギーの影響が特に大きいことを説明します。',
    indicatorIds: ['cgpi-gas', 'cgpi-industrial-gas', 'cgpi-lpg', 'cgpi-heavy-oil-a', 'cgpi-electricity'],
    suggestedOwnDocuments: ['ガス・電力・燃料の料金明細', '炉の稼働記録'],
    howToExplain: 'ガス・LPG・重油・電力の公的指数で上昇傾向を示し、自社の炉稼働・料金で実負担を補足します。',
  },
  {
